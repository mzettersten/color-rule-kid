/**
 * jspsych-html-audio-button-response
 * Kristin Diep; MZ addition of an html stimulus
 *
...
jsPsych.plugins["html-audio-button-response"] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    // display stimulus
    var html = '<div id="jspsych-html-button-response-stimulus">'+trial.html_stimulus+'</div>';
